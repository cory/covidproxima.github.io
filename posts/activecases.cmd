...
# How many people are infectuous in the United States right now?

My best guess is that [text 1] people are infectuous right now. Put another way, that's [text 5]. What are my assumptions?
...
Currently *infectuous people* is then probable cases from 6 days ago minus current recoveries.
